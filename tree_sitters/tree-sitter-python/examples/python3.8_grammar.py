...
from My_utils.support import check_syntax_error
import inspect
import unittest
import sys
# testing import *
...
import My_utils.ann_module as ann_module
import typing
from collections import ChainMap
from My_utils import ann_module2
import My_utils
...
class GrammarTests(unittest.TestCase):
    ...
    def test_var_annot_in_module(self):
        ...
        from My_utils.ann_module3 import f_bad_ann, g_bad_ann, D_bad_ann
        with self.assertRaises(NameError):
            f_bad_ann()
        with self.assertRaises(NameError):
            g_bad_ann()
